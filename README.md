...
[![Paper](https://img.shields.io/badge/Paper-1.21.x-blue?style=flat-square)](https://papermc.io/)
...
- Folia & Paper uyumlu — `RegionScheduler`, `AsyncScheduler` ve `player.getScheduler()` doğru kullanılmıştır
